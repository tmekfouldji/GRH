<template>
    <Head title="Modifier pointage" />
    
    <div class="max-w-2xl mx-auto">
        <div class="card">
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-xl font-semibold text-gray-800">Modifier le pointage</h2>
            ...
            <form @submit.prevent="submit" class="space-y-4">
                ...
                <div>
                    ...
                    <input v-model="form.date_pointage" type="date" class="input" />
                </div>
...
const props = defineProps({ pointage: Object, employes: Array });

const form = useForm({
    employe_id: props.pointage.employe_id,
    date_pointage: props.pointage.date_pointage?.split('T')[0],
    heure_entree: props.pointage.heure_entree || '',
    heure_sortie: props.pointage.heure_sortie || '',
    statut: props.pointage.statut,
    commentaire: props.pointage.commentaire || '',
});

const submit = () => form.put(`/pointages/${props.pointage.id}`);
</script>
