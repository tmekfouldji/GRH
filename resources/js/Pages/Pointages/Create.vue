        ...
        <div class="card">
            ...
            <form @submit.prevent="submit" class="space-y-4">
                ...
                <div>
                    ...
                    <input v-model="form.date_pointage" type="date" class="input" :class="{ 'border-red-500': errors.date_pointage }" />
                    <p v-if="errors.date_pointage" class="text-red-500 text-sm mt-1">{{ errors.date_pointage }}</p>
                </div>
