...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/simulateur-salaire', function () {
        return Inertia::render('SalaireCalculateur');
    })->name('simulateur-salaire');

    // Simulateur Inversé
    Route::get('/simulateur-inverse', function () {
        return Inertia::render('SalaireCalculateurInverse');
    })->name('simulateur-inverse');
    ...
    // API for activity logs (for real-time updates)
    Route::get('api/activity-logs/latest', [ActivityLogController::class, 'latest'])->name('activity-logs.latest');
});
